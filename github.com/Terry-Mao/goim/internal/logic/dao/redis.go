...
func (d *Dao) AddMapping(c context.Context, mid int64, key, server string) (err error) {
	...
	var n = 2
	if mid > 0 {
		//keyMidServer(mid)=mid_123  e454b8e3-4250-4734-8310-5771b448b085  192.168.11.1
	...
	//keyKeyServer(key)=key_ e454b8e3-4250-4734-8310-5771b448b085 192.168.11.1
	if err = conn.Send("SET", keyKeyServer(key), server); err != nil {
		log.Errorf("conn.Send(HSET %d,%s,%s) error(%v)", mid, server, key, err)
		return
	} //key_0safd0sdsf97d8f 1秒
...
func (d *Dao) ServersByKeys(c context.Context, keys []string) (res []string, err error) {
	...
	//args=["key_e454b8e3-4250-4734-8310-5771b448b085","key_e454b8e3-4250-4734-8310-5771b448b085"]
	//res=["192.168.11.1","192.168.11.2","192.168.11.3"]
