(function(win) {
    ...
    Client.prototype.createConnect = function(max, delay) {
        ...
        function connect() {
            var ws = new WebSocket('ws://192.168.10.200:3102/sub');
                ...
                switch(op) {
                    ...
                    case 9:
                        ...
                        for (var offset=rawHeaderLen; offset<data.byteLength; offset+=packetLen) {
                            console.log("case 9: batch message packetLen="+packetLen);
                            // parse
            ...
            function auth() {
                var token = '{"mid":456, "room_id":"live://1000", "platform":"web", "accepts":[1000,1001,1002]}'
                var headerBuf = new ArrayBuffer(rawHeaderLen);
                var headerView = new DataView(headerBuf, 0);
